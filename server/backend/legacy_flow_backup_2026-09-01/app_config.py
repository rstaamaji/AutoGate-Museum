...
class Settings:
    ...
    TICKET_PENDING_TTL_HOURS: int = int(os.getenv("TICKET_PENDING_TTL_HOURS", "12"))
    PUBLIC_PAYMENT_URL: str = os.getenv(
        "PUBLIC_PAYMENT_URL", "http://localhost:8000/api/public/payment"
    ).rstrip("/")
    ...
    # Konfigurasi Printer Thermal (VID & PID atau Nama Spooler)
    PRINTER_VID: str = os.getenv("PRINTER_VID", "0x0416")
    PRINTER_PID: str = os.getenv("PRINTER_PID", "0x5011")
